<h2 class="text-center p-3 mb-8 text-xl" style="background-color:#343A40 ; color: #fff; border-radius: 8px;"> QUẢN LÝ BANNER</h2>
...
<form action="" method="POST">
    ...
    <div class="row mt-4" style="margin-top: 16px;">
        ...
        <input onclick="return confirm('Bạn có chắc muốn xóa loại hàng này không ?')" type="submit" value="Xóa các mục chọn" name="del_click" class=" py-1 px-4  mr-3 " style="border-radius: 4px; border: 1px solid #3f3f3f; background-color: #fff; padding: 4px 16px;">
